...
export const providerProfiles: ProviderProfile[] = [
  ...
  },
  {
    ...
    allowedModels: [],
    primaryModel: "",
    consumerScopes: ["strategist", "setup", "routine", "recovery"],
    shared: true,
    status: "fallback",
    credentialStatus: "missing",
  },
...
export const runtimeNodes: ProviderRuntimeNode[] = [
  ...
  },
  {
    ...
    deployableOnDemand: false,
    notes: ["User-owned LAN runtime reachable via an OpenAI-compatible HTTP endpoint; setup probe populates endpoint and model list."],
  },
  {
  ...
  fallbackPolicies: [
    {
      ...
      orderedProviderProfileIds: ["shared-minimax", "shared-openai", "shared-lan", "shared-local"],
      orderedRuntimeNodeIds: ["node-minimax-cloud", "node-openai-cloud", "node-lan-runtime", "node-gx10-qwen", "node-local-resurrect"],
